...
public class Runner {
    ...
    public static void runner() {
        ...
        String arrayOrReferences = "null";
        if (dataStructure.equals("s") || dataStructure.equals("q") || dataStructure.equals("l")) {
            arrayOrReferences = CommandLines.selectArraysOrReferences();
        }  
